...
class UniqueEmployeeActivity extends StatefulWidget {
  final UserData userData, myData;

  const UniqueEmployeeActivity({
    super.key,
  ...
  @override
  State<UniqueEmployeeActivity> createState() => _UniqueEmployeeActivityState();
}

class _UniqueEmployeeActivityState extends State<UniqueEmployeeActivity> {
